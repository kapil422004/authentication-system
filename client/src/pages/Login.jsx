...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    try {
      e.preventDefault(); //prevent relode of page after submit
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br frome-blue-200 from-blue-200 to-purple-400 ">
      <img
        onClick={() => navigate("/")}
        src={assets.logo}
        alt=""
